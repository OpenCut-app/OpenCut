    ...
    <Popover open={isExportPopoverOpen} onOpenChange={setIsExportPopoverOpen}>
      <PopoverTrigger asChild>
        <button
          type="button"
          className={cn(
            "flex items-center gap-1.5 bg-[#2D6B4F] text-white rounded-md px-[0.12rem] py-[0.12rem] transition-all duration-200",
            hasProject
        ...
        >
          <div className="flex items-center gap-1.5 bg-linear-270 from-[#1A3D2E] to-[#2D6B4F] rounded-[0.8rem] px-4 py-1 relative shadow-[0_1px_3px_0px_rgba(0,0,0,0.65)]">
            ...
            <div className="absolute w-full h-full left-0 top-0 bg-linear-to-t from-white/0 to-white/50 z-10 rounded-[0.8rem] flex items-center justify-center">
              <div className="absolute w-[calc(100%-2px)] h-[calc(100%-2px)] top-[0.08rem] bg-linear-270 from-[#1A3D2E] to-[#2D6B4F] z-50 rounded-[0.8rem]"></div>
            </div>
          </div>
        </button>
      </PopoverTrigger>
