          ...
          if (time >= elementStart && time < elementEnd) {
            if (element.type === "media") {
              ...
              activeElements.push({
                ...
                backgroundPaddingX: textElement.backgroundPaddingX,
                backgroundPaddingY: textElement.backgroundPaddingY,
                outlineColor: textElement.outlineColor,
                outlineWidth: textElement.outlineWidth,
                boxShadowColor: textElement.boxShadowColor,
                boxShadowOffsetX: textElement.boxShadowOffsetX,
                boxShadowOffsetY: textElement.boxShadowOffsetY,
                boxShadowOpacity: textElement.boxShadowOpacity,
                x: textElement.x,
                y: textElement.y,
